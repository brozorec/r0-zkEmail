...
const JOURNAL_HEX: &str = "";
...
fn test_decode_journal() {
    ...
    assert_eq!(output.receiver_pub_key.len(), 65);
    // First byte should be 0x04 (uncompressed key prefix)
    let mut passkey_arr = [0u8; 65];
    output.receiver_pub_key.copy_into_slice(&mut passkey_arr);
...
#[test]
#[should_panic(expected = "receiver_pub_key must be 65 bytes")]
